...
|------|------|-------------|-------|---------|
|[![github](https://github.com/buluma/ansible-role-backup/actions/workflows/molecule.yml/badge.svg)](https://github.com/buluma/ansible-role-backup/actions/workflows/molecule.yml)|[![Issues](https://img.shields.io/github/issues/buluma/ansible-role-backup.svg)](https://github.com/buluma/ansible-role-backup/issues/)|[![PullRequests](https://img.shields.io/github/issues-pr-closed-raw/buluma/ansible-role-backup.svg)](https://github.com/buluma/ansible-role-backup/pulls/)|[![Version](https://img.shields.io/github/release/buluma/ansible-role-backup.svg)](https://github.com/buluma/ansible-role-backup/releases/)|[![Ansible Role](https://img.shields.io/ansible/role/d/buluma/backup)](https://galaxy.ansible.com/ui/standalone/roles/buluma/backup/documentation)|
...
### Get Help
- Report issues: https://github.com/buluma/ansible-role-backup/issues/new
- See docs: https://docs.ansible.com/collection/gallery/ansible-role-backup
